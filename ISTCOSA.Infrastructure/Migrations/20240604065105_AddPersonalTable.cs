        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnniversaryDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ISTCNickName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ISTCFriend = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ISTCAbout = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPersonalInformation_AspNetUsers_UserId",
                        column: x => x.UserId,
